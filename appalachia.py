...
# if you want full color plot comment out the lines with cropped in it            
            ...
            cropped = (slice(108, 220, None), slice(290, 410, None))
        ...
        ax.set_extent([-86, -72, 37, 43], crs=crs.PlateCarree()) 
        ...
        print(figname)
        plt.savefig(os.path.join('/work2/08605/tg879045/appalachia',figname),dpi=300,format='png', bbox_inches = 'tight',pad_inches = 0)
        plt.clf()#
        plt.close()
    i = i+1
